...
def log(payload):
    ...
    # log to file
    try:
        file = open("/Users/Peregrine/Desktop/Projects/randomProjects/class_work/case_study/ip_port_log.txt", "a")  # open log in append mode
...
def scan_ports(network_ip, host_ip):
    ...
    try:
        with open("/Users/Peregrine/Desktop/Projects/randomProjects/class_work/case_study/ports.txt", "r") as ports:
            if getsize('/Users/Peregrine/Desktop/Projects/randomProjects/class_work/case_study/ports.txt') == 0:
